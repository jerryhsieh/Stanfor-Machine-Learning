displayData <- function(X, example_width) {
   ...
   example_height <- (n / example_width)
    ...
    # Setup blank display
    display_array = - matrix(1, pad + display_rows * (example_height + pad),pad + display_cols * (example_width + pad))
    ...
    h <- imagesc(display_array, col=gray(0:16/16))
