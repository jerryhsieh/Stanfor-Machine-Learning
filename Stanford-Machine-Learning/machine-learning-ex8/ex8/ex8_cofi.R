...
#  Evaluate cost function
J = cofiCostFunc(as.vector(c(as.vector(X), as.vector(Theta))), Y, R, num_users, num_movies, num_features, 1.5)

message(sprintf('Cost at loaded parameters (lambda = 1.5): %f ', J[[1]]))
